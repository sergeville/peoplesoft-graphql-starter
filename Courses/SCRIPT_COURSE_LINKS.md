...
| [Module 9](./COURSE.md#module-9--crud-mutations--forms) | CRUD UI (delete = terminate) | `npm run dev` or `npm run dev:mock-ps` | [`EmployeeForm.tsx`](../frontend/components/EmployeeForm.tsx) — [CODE_PATH § terminate](CODE_PATH_GRAPHQL_TO_PS.md#ps-terminate-vs-delete) |
